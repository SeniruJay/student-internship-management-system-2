...
export default function StudentDashboard() {
  ...
  return (
    <div className="min-h-screen relative">
      ...
      {activeTab === 'profile' && (
        <div className="bg-white/20 dark:bg-zinc-900/20 backdrop-blur-xl p-10 rounded-[2rem] shadow-sm border border-white/30 dark:border-zinc-700/30 transition-colors duration-300 max-w-4xl mx-auto">
          ...
          <form onSubmit={handleProfileSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-6">
            <div>
              ...
              <input type="number" step="0.01" value={gpa} onChange={e => setGpa(e.target.value)} className="block w-full rounded-xl border-0 py-3 px-4 text-zinc-900 dark:text-zinc-50 shadow-sm ring-1 ring-inset ring-white/30 dark:ring-zinc-700/50 placeholder:text-zinc-500 focus:ring-2 focus:ring-inset focus:ring-white/50 dark:focus:ring-zinc-600/50 sm:text-sm sm:leading-6 bg-white/10 dark:bg-zinc-800/10 backdrop-blur-sm transition-shadow" />
            </div>
            <div>
              <label className="block text-sm font-semibold text-zinc-700 dark:text-zinc-300 mb-2">University Year</label>
              <input type="text" value={year} onChange={e => setYear(e.target.value)} className="block w-full rounded-xl border-0 py-3 px-4 text-zinc-900 dark:text-zinc-50 shadow-sm ring-1 ring-inset ring-white/30 dark:ring-zinc-700/50 placeholder:text-zinc-500 focus:ring-2 focus:ring-inset focus:ring-white/50 dark:focus:ring-zinc-600/50 sm:text-sm sm:leading-6 bg-white/10 dark:bg-zinc-800/10 backdrop-blur-sm transition-shadow" placeholder="e.g. 3rd Year" />
            </div>
            <div>
              <label className="block text-sm font-semibold text-zinc-700 dark:text-zinc-300 mb-2">Contact Number</label>
              <input type="text" value={contact} onChange={e => setContact(e.target.value)} className="block w-full rounded-xl border-0 py-3 px-4 text-zinc-900 dark:text-zinc-50 shadow-sm ring-1 ring-inset ring-white/30 dark:ring-zinc-700/50 placeholder:text-zinc-500 focus:ring-2 focus:ring-inset focus:ring-white/50 dark:focus:ring-zinc-600/50 sm:text-sm sm:leading-6 bg-white/10 dark:bg-zinc-800/10 backdrop-blur-sm transition-shadow" />
            </div>
            <div>
              <label className="block text-sm font-semibold text-zinc-700 dark:text-zinc-300 mb-2">Address</label>
              <input type="text" value={address} onChange={e => setAddress(e.target.value)} className="block w-full rounded-xl border-0 py-3 px-4 text-zinc-900 dark:text-zinc-50 shadow-sm ring-1 ring-inset ring-white/30 dark:ring-zinc-700/50 placeholder:text-zinc-500 focus:ring-2 focus:ring-inset focus:ring-white/50 dark:focus:ring-zinc-600/50 sm:text-sm sm:leading-6 bg-white/10 dark:bg-zinc-800/10 backdrop-blur-sm transition-shadow" />
            </div>
            <div className="md:col-span-2">
              <label className="block text-sm font-semibold text-zinc-700 dark:text-zinc-300 mb-2">CV Link (Google Drive, etc.)</label>
              <input type="url" value={cvUrl} onChange={e => setCvUrl(e.target.value)} className="block w-full rounded-xl border-0 py-3 px-4 text-zinc-900 dark:text-zinc-50 shadow-sm ring-1 ring-inset ring-white/30 dark:ring-zinc-700/50 placeholder:text-zinc-500 focus:ring-2 focus:ring-inset focus:ring-white/50 dark:focus:ring-zinc-600/50 sm:text-sm sm:leading-6 bg-white/10 dark:bg-zinc-800/10 backdrop-blur-sm transition-shadow" placeholder="https://..." />
            </div>
            <div className="md:col-span-2">
              <label className="block text-sm font-semibold text-zinc-700 dark:text-zinc-300 mb-2">Additional Details</label>
              <textarea value={additionalDetails} onChange={e => setAdditionalDetails(e.target.value)} rows={4} className="block w-full rounded-xl border-0 py-3 px-4 text-zinc-900 dark:text-zinc-50 shadow-sm ring-1 ring-inset ring-white/30 dark:ring-zinc-700/50 placeholder:text-zinc-500 focus:ring-2 focus:ring-inset focus:ring-white/50 dark:focus:ring-zinc-600/50 sm:text-sm sm:leading-6 bg-white/10 dark:bg-zinc-800/10 backdrop-blur-sm transition-shadow"></textarea>
            </div>
            <div className="md:col-span-2 mt-2">
              <button type="submit" className="w-full bg-white/30 dark:bg-zinc-800/30 backdrop-blur-sm text-zinc-900 dark:text-zinc-50 px-6 py-3.5 rounded-full text-base font-semibold hover:scale-[1.02] active:scale-[0.98] shadow-md border border-white/40 dark:border-zinc-600/40 transition-all focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-white/50 dark:focus:ring-zinc-600/50">Save Profile</button>
            </div>
          </form>
        </div>
      )}
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {internships.map(internship => (
              <div key={internship._id} className="bg-white/20 dark:bg-zinc-900/20 backdrop-blur-xl p-8 rounded-3xl shadow-sm border border-white/30 dark:border-zinc-700/30 hover:shadow-md hover:-translate-y-1 transition-all duration-300 flex flex-col">
                ...
                <div className="text-sm text-zinc-600 dark:text-zinc-400 mb-6 bg-white/10 dark:bg-zinc-800/10 backdrop-blur-sm p-4 rounded-2xl border border-white/20 dark:border-zinc-700/50">
                ...
                <button
                  ...
                  className="w-full bg-white/30 dark:bg-zinc-800/30 backdrop-blur-sm text-zinc-900 dark:text-zinc-50 px-6 py-3.5 rounded-full text-base font-semibold hover:scale-[1.02] active:scale-[0.98] shadow-sm border border-white/40 dark:border-zinc-600/40 transition-all focus:outline-none"
                >
                  Apply Now
                </button>
              </div>
      ...
      {activeTab === 'viva' && (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div className="bg-white/20 dark:bg-zinc-900/20 backdrop-blur-xl p-10 rounded-[2rem] shadow-sm border border-white/30 dark:border-zinc-700/30 transition-colors duration-300">
            ...
            <form onSubmit={handleReportSubmit} className="space-y-6">
              <div>
                ...
                <textarea name="content" required rows={5} className="block w-full rounded-xl border-0 py-3 px-4 text-zinc-900 dark:text-zinc-50 shadow-sm ring-1 ring-inset ring-white/30 dark:ring-zinc-700/50 placeholder:text-zinc-500 focus:ring-2 focus:ring-inset focus:ring-white/50 dark:focus:ring-zinc-600/50 sm:text-sm sm:leading-6 bg-white/10 dark:bg-zinc-800/10 backdrop-blur-sm transition-shadow"></textarea>
              </div>
              <div>
                <label className="block text-sm font-semibold text-zinc-700 dark:text-zinc-300 mb-2">Report Link (Google Drive, etc.)</label>
                <input type="url" name="fileUrl" required className="block w-full rounded-xl border-0 py-3 px-4 text-zinc-900 dark:text-zinc-50 shadow-sm ring-1 ring-inset ring-white/30 dark:ring-zinc-700/50 placeholder:text-zinc-500 focus:ring-2 focus:ring-inset focus:ring-white/50 dark:focus:ring-zinc-600/50 sm:text-sm sm:leading-6 bg-white/10 dark:bg-zinc-800/10 backdrop-blur-sm transition-shadow" placeholder="https://..." />
              </div>
              <button type="submit" className="w-full bg-white/30 dark:bg-zinc-800/30 backdrop-blur-sm text-zinc-900 dark:text-zinc-50 px-6 py-3.5 rounded-full text-base font-semibold hover:scale-[1.02] active:scale-[0.98] shadow-md border border-white/40 dark:border-zinc-600/40 transition-all focus:outline-none">Submit Report</button>
            </form>
          </div>

          <div className="bg-white/10 dark:bg-zinc-800/10 backdrop-blur-sm p-10 rounded-[2rem] shadow-sm border border-white/20 dark:border-zinc-700/30 transition-colors duration-300">
            <h2 className="text-2xl font-bold mb-8 text-zinc-900 dark:text-zinc-50 tracking-tight">Viva Schedules</h2>
            <div className="space-y-4">
              {vivas.map(viva => (
                <div key={viva._id} className="border border-white/20 dark:border-zinc-700/50 rounded-3xl p-6 bg-white/10 dark:bg-zinc-800/10 backdrop-blur-sm shadow-sm transition-colors">
                  <div className="flex justify-between items-start mb-4">
                    <h3 className="text-lg font-bold text-zinc-900 dark:text-zinc-50 tracking-tight">Lecturer: {viva.lecturer?.name}</h3>
                    {viva.grade && <span className="bg-white/20 dark:bg-zinc-700/50 backdrop-blur-sm text-zinc-900 dark:text-zinc-50 border border-white/30 dark:border-zinc-600/50 text-xs font-bold px-3 py-1.5 rounded-full uppercase tracking-wider">Grade: {viva.grade}</span>}
                  </div>
                  <div className="bg-white/10 dark:bg-zinc-800/10 backdrop-blur-sm border border-white/20 dark:border-zinc-700/50 p-4 rounded-2xl space-y-2">
